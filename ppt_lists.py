# Name: Bryan Silva
# Program Purpose: This program uses lists to find the personal property tax for veihicles in Charlottesville
...
#       -- Eligibility: Owned or leased vehicles which are predominately used for non-business purpose & have passenger license plates
...
def display_results():
    ...
    for i in range(num_vehicles):
        ...
        dateline2 = pptr_eligible[i] + tab + format(ppt_owned[i],moneyf)
